<script lang="ts">
    import CitationItem from "../../components/appendix/CitationItem.svelte";
    import type { PageData } from "../references/$types";
...
>
    ...
    <hr class="w-8/12 lg:w-5/12 md:w-6/12 m-auto mt-2 mb-10" />
